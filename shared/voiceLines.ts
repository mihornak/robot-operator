...
export const VOICE_BANK: BankLine[] = [
  ...
  { id: 'new_brain', text: 'New brain! Robot has ideas now.' },
  { id: 'brain_hint', text: 'Robot can hide. And avoid. And plans.' },
  { id: 'hide_done', text: 'Robot is invisible now. Probably.' },
  { id: 'avoid_ok', text: 'Robot avoids it. Forever.' },
  { id: 'idle_ideas', text: 'Robot is having ideas. Big ones.' },
  { id: 'idle_tactics', text: 'Robot knows tactics now. Ask robot.' },
